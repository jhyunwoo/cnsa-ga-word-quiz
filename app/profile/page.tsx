  ...
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
      ...
      <Link
        ...
        className="w-full p-4 rounded-lg flex justify-center items-center bg-white shadow-lg text-lg font-semibold hover:bg-slate-100 transition duration-200 md:text-center"
      >
        <div>테스트 기록</div>
      </Link>
